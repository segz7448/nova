    ...
    return [
      {
        ...
        execute: async (args) => {
          ...
          try {
            const result = await this.context.backend.exec(command, timeoutMs);
      ...
      },
      {
        ...
        execute: async (args) => {
          ...
          try {
            await this.context.backend.writeFile(confined, content);
      ...
      },
      {
        ...
        execute: async (args) => {
          ...
          try {
            let content: string;
            try {
              content = await this.context.backend.readFile(confined);
            } catch {
      ...
      },
      {
        ...
        execute: async (args) => {
          ...
          try {
            ...
            try {
              await this.context.backend.writeFile(confined, patched);
            } catch {

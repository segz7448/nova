 ...
 * write_file and read_file operate on the remote sandbox via your backend's API,
 * so local cwd-based traversal checks are not meaningful for them and
 * will false-positive on every absolute sandbox path (e.g. /home/backend/app.py).
 */
